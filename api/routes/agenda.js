 ...
 * Apaga a agenda de eventos pelo id
 */

router.delete('/:id', async(req, res) => {
    await db.collection(nomeCollection)
    .deleteOne({"_id": { $eq: ObjectId(req.params.id)}})
    TouchEvent(result => res.status(200).send(result))
 ...
 */
router.post('/', validaAgenda, async(req, res) => {
 ...
 */
router.put('/', validaAgenda, async(req, res) => {
